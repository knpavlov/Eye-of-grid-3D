...
// Вариант колоды с упором на агрессию
export const BLAZING_TRIAL_SET = [
  CARDS.FIRE_FLAME_MAGUS,
  CARDS.FIRE_HELLFIRE_SPITTER,
  CARDS.FIRE_HELLFIRE_SPITTER,
  CARDS.FIRE_FREEDONIAN,
...
// Колода только из существ, без заклинаний
export const CREATURES_ONLY_SET = [
  CARDS.FIRE_FLAME_MAGUS,
  CARDS.FIRE_FLAME_MAGUS,
  CARDS.FIRE_FLAME_MAGUS,
  CARDS.FIRE_HELLFIRE_SPITTER,
...
// Колода с большим количеством заклинаний
export const ARCANE_GAMBIT_SET = [
  CARDS.FIRE_FLAME_MAGUS,
  CARDS.FIRE_HELLFIRE_SPITTER,
  CARDS.FIRE_FREEDONIAN,
  CARDS.FIRE_FLAME_LIZARD,
