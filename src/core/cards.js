...
export const CARDS = {
  ...
  // Spells (subset)
  SPELL_HEALING_SHOWER: { id:'SPELL_HEALING_SHOWER', name:'Healing Shower', type:'SPELL', element:'NEUTRAL', spellType:'CONJURATION', cost:2, text:'All allied creatures of a chosen element gain 3 HP. Place this card on an allied creature belonging to the desired element.' },
