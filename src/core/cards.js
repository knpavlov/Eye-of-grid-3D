...
export const CARDS = {
  ...
  FIRE_PARTMOLE_FLAME_LIZARD: {
    ...
    attackType: 'STANDARD', firstStrike: true, attackCostReduction: 1,
    attacks: [ { dir: 'N', ranges: [1] } ],
    blindspots: ['S'],
  ...
  FIRE_GREAT_MINOS: {
    ...
    blindspots: ['S'], perfectDodge: true, attackCostReduction: 1, diesOffElement: 'FIRE',
    desc: 'Perfect Dodge. Attacks and counterattacks two spaces ahead. The activation cost to attack is 1 less. Destroy Great Minos if he is on a non‑Fire field.'
  },
  FIRE_FLAME_ASCETIC: {
    id: 'FIRE_FLAME_ASCETIC', name: 'Flame Ascetic', type: 'UNIT', cost: 3, activation: 3,
    element: 'FIRE', atk: 2, hp: 3,
    attackType: 'STANDARD', attackCostReduction: 2,
    attacks: [ { dir: 'N', ranges: [1] } ],
  ...
  FIRE_PURSUER_OF_SAINT_DHEES: {
    ...
    element: 'FIRE', atk: 5, hp: 4,
    attackType: 'STANDARD', attackCostReduction: 5,
    attacks: [ { dir: 'N', ranges: [1] } ],
