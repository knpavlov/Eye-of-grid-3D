...
const RAW_CARDS = {
  ...
  SPELL_SCIONDAR_INFERNO: {
    ...
    spellType: 'SORCERY',
    cost: 0,
    text: 'Discard two creatures from your hand (at least one Fire creature). Choose a Fire field; enemies on that field and adjacent fields take magic damage equal to the number of Fire fields.'
  },
  SPELL_ICE_FLOOD_OF_OKUNADA: {
    ...
    spellType: 'SORCERY',
    cost: 0,
    text: 'Discard two creatures from your hand (at least one Water creature). Choose a Water field; enemies on that field and adjacent fields take magic damage equal to the number of Water fields.'
  },
  SPELL_FIST_OF_VERZAR: {
    ...
    spellType: 'SORCERY',
    cost: 0,
    text: 'Discard two creatures from your hand (at least one Earth creature). Choose an Earth field; enemies on that field and adjacent fields take magic damage equal to the number of Earth fields.'
  },
  SPELL_WRATHFUL_WINDS_OF_JUNO: {
    ...
    spellType: 'SORCERY',
    cost: 0,
    text: 'Discard two creatures from your hand (at least one Wood creature). Choose a Wood field; enemies on that field and adjacent fields take magic damage equal to the number of Wood fields.'
  },
  SPELL_BLINDING_SKIES: {
    ...
    spellType: 'SORCERY',
    cost: 0,
    text: 'Discard two creatures from your hand (at least one Biolith creature). Choose a Biolith field; enemies on that field and adjacent fields take magic damage equal to the number of Biolith fields. Each creature is only damaged once.'
  },
  SPELL_SCIONS_RIOTOUS_IMPUNITY: {
    ...
    spellType: 'SORCERY',
    cost: 2,
    text: 'Place on the center field and choose a starting direction. Beginning with the chosen side and moving clockwise, each creature on the board immediately conducts a battle. Playing this card ends your turn.'
  },
