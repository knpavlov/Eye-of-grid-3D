...
const RAW_CARDS = {
  ...
  SPELL_SUMMONER_MESMERS_LAPSE: {
    ...
    spellType: 'RITUAL',
    cost: 0,
    ritualCost: 'discard 1 creature (offer)',
    text: 'Discard a creature from hand. Opponent loses mana equal to its summoning cost. Both cards are offered to the Eye.'
  },
  SPELL_BEGUILING_FOG: {
    cardNumber: 94,
    race: 'Conjuration',
