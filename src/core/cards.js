...
const RAW_CARDS = {
  ...
  SPELL_SCIONDAR_INFERNO: {
    ...
    spellType: 'SORCERY',
    cost: 0,
    text: 'Discard 2 creatures (at least one Fire). Deal magic damage equal to the number of Fire fields to enemies on and adjacent to the chosen Fire field.'
  },
  SPELL_ICE_FLOOD_OF_OKUNADA: {
    ...
    spellType: 'SORCERY',
    cost: 0,
    text: 'Discard 2 creatures (at least one Water). Deal magic damage equal to the number of Water fields to enemies on and adjacent to the chosen Water field.'
  },
  SPELL_FIST_OF_VERZAR: {
    ...
    spellType: 'SORCERY',
    cost: 0,
    text: 'Discard 2 creatures (at least one Earth). Deal magic damage equal to the number of Earth fields to enemies on and adjacent to the chosen Earth field.'
  },
  SPELL_WRATHFUL_WINDS_OF_JUNO: {
    ...
    spellType: 'SORCERY',
    cost: 0,
    text: 'Discard 2 creatures (at least one Forest). Deal magic damage equal to the number of Forest fields to enemies on and adjacent to the chosen Forest field.'
  },
  SPELL_BLINDING_SKIES: {
    ...
    spellType: 'SORCERY',
    cost: 0,
    text: 'Discard 2 creatures (at least one Biolith). Deal magic damage equal to the number of Biolith fields to enemies on and adjacent to the chosen Biolith field.'
  },
  SPELL_SCIONS_RIOTOUS_IMPUNITY: {
    ...
    spellType: 'SORCERY',
    cost: 2,
    text: 'Starting from the center field, each creature on the board attacks in clockwise order. Playing this card ends your turn.'
  },
