...
const RAW_CARDS = {
  ...
  SPELL_SCIONDAR_INFERNO: {
    ...
    spellType: 'DOMINION',
    cost: 0,
    text: 'Discard 2 creatures (at least one Fire). Deal magic damage equal to the number of Fire fields to all enemies on a chosen Fire field and its orthogonal neighbors.'
  },
  SPELL_ICE_FLOOD_OF_OKUNADA: {
    ...
    spellType: 'DOMINION',
    cost: 0,
    text: 'Discard 2 creatures (at least one Water). Deal magic damage equal to the number of Water fields to all enemies on a chosen Water field and its orthogonal neighbors.'
  },
  SPELL_FIST_OF_VERZAR: {
    ...
    spellType: 'DOMINION',
    cost: 0,
    text: 'Discard 2 creatures (at least one Earth). Deal magic damage equal to the number of Earth fields to all enemies on a chosen Earth field and its orthogonal neighbors.'
  },
  SPELL_WRATHFUL_WINDS_OF_JUNO: {
    ...
    spellType: 'DOMINION',
    cost: 0,
    text: 'Discard 2 creatures (at least one Wood). Deal magic damage equal to the number of Wood fields to all enemies on a chosen Wood field and its orthogonal neighbors.'
  },
  SPELL_BLINDING_SKIES: {
    ...
    spellType: 'DOMINION',
    cost: 0,
    text: 'Discard 2 creatures (at least one Biolith). Deal magic damage equal to the number of Biolith fields to all enemies on and orthogonally adjacent to Biolith fields (each creature is affected once).'
  },
  SPELL_SCIONS_RIOTOUS_IMPUNITY: {
    ...
    spellType: 'SORCERY',
    cost: 2,
    text: 'Starting from the center field, every creature battles in clockwise order. Playing this card ends your turn.'
  },
