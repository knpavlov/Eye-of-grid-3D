...
// Здесь собраны шаблоны карт. Мы полностью перешли на новую систему описания атак.

export const CARDS = {
  // Fire Set (subset extracted; extend as needed)

  // Маг: атакует магией, направления не заданы
  FIRE_FLAME_MAGUS: {
    id: 'FIRE_FLAME_MAGUS',
    name: 'Flame Magus',
    type: 'UNIT',
  ...
  FIRE_FREEDONIAN: {
    ...
    blindspots: ['S'],
    auraGainManaOnSummon: true,
    desc: 'While not on Fire tile, you gain 1 mana on allied summon.'
  },

  FIRE_FLAME_LIZARD: {
    id: 'FIRE_FLAME_LIZARD',
    name: 'Partmole Flame Lizard',
    type: 'UNIT',
    cost: 2,
    activation: 1,
    element: 'FIRE',
