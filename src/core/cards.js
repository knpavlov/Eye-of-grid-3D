...
const RAW_CARDS = {
  ...
  SPELL_SCIONDAR_INFERNO: {
    ...
    text: 'Discard 2 creatures (at least 1 Fire). Choose a Fire field. Deal X magic damage to all enemy creatures on and adjacent to that field. X equals the number of Fire fields.'
  },
  SPELL_ICE_FLOOD_OF_OKUNADA: {
    ...
    cost: 0,
    ritualCost: 'discard 2 creatures',
    text: 'Discard 2 creatures (at least 1 Water). Choose a Water field. Deal X magic damage to all enemy creatures on and adjacent to that field. X equals the number of Water fields.'
  },
  SPELL_FIST_OF_VERZAR: {
    ...
    cost: 0,
    ritualCost: 'discard 2 creatures',
    text: 'Discard 2 creatures (at least 1 Earth). Choose an Earth field. Deal X magic damage to all enemy creatures on and adjacent to that field. X equals the number of Earth fields.'
  },
  SPELL_WRATHFUL_WINDS_OF_JUNO: {
    ...
    cost: 0,
    ritualCost: 'discard 2 creatures',
    text: 'Discard 2 creatures (at least 1 Wood). Choose a Wood field. Deal X magic damage to all enemy creatures on and adjacent to that field. X equals the number of Wood fields.'
  },
  SPELL_BLINDING_SKIES: {
    ...
    cost: 0,
    ritualCost: 'discard 2 creatures',
    text: 'Discard 2 creatures (at least 1 Biolith). Choose a Biolith field. Deal X magic damage to all enemy creatures on and adjacent to that field. X equals the number of Biolith fields. Each creature is damaged only once.'
  },
