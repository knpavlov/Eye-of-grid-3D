...
export const CARDS = {
  ...
  FIRE_FIREFLY_NINJA: {
    ...
    attackType: 'STANDARD',
    attacks: [ { dir: 'N', ranges: [1] } ],
    blindspots: ['S'], perfectDodgeOnFire: true,
  ...
  FIRE_DIDI_THE_ENLIGHTENED: {
    ...
    desc: 'Quickness. Attacks the same target twice. Adds 1 to his Attack if the target creature is on a Fire field.'
  },
  FIRE_WARDEN_HILDA: {
    ...
    desc: 'Adds 1 to her Attack if the target is a Fire creature. If summoned on a non‑Fire field, gain possession of enemies on Fire fields.'
  },
  FIRE_CRUCIBLE_KING_DIOS_IV: {
    ...
    desc: 'Attacks the same target twice. While on a Fire field he must use a Magic Attack hitting the target and adjacent enemies. Attack equals the number of Fire fields.'
  },
  ...
  FIRE_RED_CUBIC: {
    ...
    attackType: 'STANDARD',
    attacks: [], blindspots: ['E','S','W'], sacrificeTransform: true,
    desc: 'Sacrifice Red Cubic to summon a non‑cubic Fire creature in its place without paying its cost. The summoned creature cannot attack this turn.'
  },
