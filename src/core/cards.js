...
const RAW_CARDS = {
  ...
  SPELL_SCIONDAR_INFERNO: {
    ...
    text: 'Discard 2 creature cards from your hand (at least one Fire). Deal magic damage equal to the number of Fire fields to all enemy creatures on and adjacent to a chosen Fire field.'
  },
  SPELL_ICE_FLOOD_OF_OKUNADA: {
    ...
    cost: 0,
    ritualCost: 'discard 2 creatures',
    text: 'Discard 2 creature cards from your hand (at least one Water). Deal magic damage equal to the number of Water fields to all enemy creatures on and adjacent to a chosen Water field.'
  },
  SPELL_FIST_OF_VERZAR: {
    ...
    cost: 0,
    ritualCost: 'discard 2 creatures',
    text: 'Discard 2 creature cards from your hand (at least one Earth). Deal magic damage equal to the number of Earth fields to all enemy creatures on and adjacent to a chosen Earth field.'
  },
  SPELL_WRATHFUL_WINDS_OF_JUNO: {
    ...
    cost: 0,
    ritualCost: 'discard 2 creatures',
    text: 'Discard 2 creature cards from your hand (at least one Wood). Deal magic damage equal to the number of Wood fields to all enemy creatures on and adjacent to a chosen Wood field.'
  },
  SPELL_BLINDING_SKIES: {
    ...
    cost: 0,
    ritualCost: 'discard 2 creatures',
    text: 'Discard 2 creature cards from your hand (at least one Biolith). Deal magic damage equal to the number of Biolith fields to all enemy creatures on and adjacent to a chosen Biolith field. Each target is affected once.'
  },
  SPELL_SCIONS_RIOTOUS_IMPUNITY: {
    ...
    spellType: 'SORCERY',
    cost: 2,
    text: 'Starting from the center field, all creatures battle one after another in clockwise order. Playing this card ends your turn.'
  },
