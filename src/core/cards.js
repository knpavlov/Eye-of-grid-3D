...
const RAW_CARDS = {
  ...
  SPELL_FIST_OF_VERZAR: {
    ...
    cost: 0,
    ritualCost: 'discard 2 creatures',
    text: 'Discard 2 creatures (at least one Earth). Deal magic damage equal to the number of Earth fields to all enemy creatures on and adjacent to a chosen Earth field.'
  },
  SPELL_WRATHFUL_WINDS_OF_JUNO: {
    ...
    cost: 0,
    ritualCost: 'discard 2 creatures',
    text: 'Discard 2 creatures (at least one Wood). Deal magic damage equal to the number of Wood fields to all enemy creatures on and adjacent to a chosen Wood field.'
  },
  SPELL_BLINDING_SKIES: {
    ...
    cost: 0,
    ritualCost: 'discard 2 creatures',
    text: 'Discard 2 creatures (at least one Biolith). Deal magic damage equal to the number of Biolith fields to all enemy creatures on and adjacent to a chosen Biolith field. Each target is affected once.'
  },
