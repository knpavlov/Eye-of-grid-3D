...
export function open(deck = null, onDone) {
  ...
  // Блок с управляющими кнопками (сохранить / отменить)
  ...
  cancelBtn.className = 'overlay-panel px-3 py-1.5 hover:bg-slate-700';
  // Кнопка отмены — закрываем редактор без сохранения изменений
