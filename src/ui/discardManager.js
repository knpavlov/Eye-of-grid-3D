...
import { pauseTurnTimer, resumeTurnTimer } from './turnTimerControl.js';

const DEFAULT_AUTO_MS = 20000;
const TIMER_PAUSE_REASON = 'forced-discard';
...
function finishRequest() {
  ...
  resumeTurnTimer(TIMER_PAUSE_REASON);
...
function beginRequest(state, req) {
  ...
  prepareSelection();
  scheduleCountdown();
  pauseTurnTimer(TIMER_PAUSE_REASON);
  notifyInputLockChanged();
}
...
const api = { initDiscardManager, syncWithState, hasActiveLocalRequest, isOverlayActive };
