...
const DEFAULT_ROTATION_LEAD = 0.32;
// Насколько быстро после старта полёта начинаем поворачивать карту
const DEFAULT_ROTATION_LEAN_DELAY = 0.0;
// Какую долю «поворота» добираемой карты выполняем ещё в полёте
const DEFAULT_DRAW_ROTATION_LEAN_FRACTION = 0.82;
// Какая часть финального промежутка отводится на удержание полётного наклона
const DEFAULT_DRAW_ROTATION_TILT_SHARE = 0.72;
