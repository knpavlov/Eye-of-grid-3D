...
import { getAttackContext, listMagicTargetCells, applyOnSummonAbilities } from './core/abilities.js';
...
try {
  ...
  window.getUnitAttackContext = getAttackContext;
  window.listMagicTargetCells = listMagicTargetCells;
  window.applyOnSummonAbilities = applyOnSummonAbilities;
